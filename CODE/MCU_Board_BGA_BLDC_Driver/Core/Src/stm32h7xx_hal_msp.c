...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_INP15
    */
    HAL_GPIO_DeInit(GPIOA, I_Phase_V_Pin|I_Phase_U_Pin|U_Phase_V_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PB0     ------> ADC2_INP9
    */
    HAL_GPIO_DeInit(U_Phase_U_GPIO_Port, U_Phase_U_Pin);

    HAL_GPIO_DeInit(U_Phase_W_GPIO_Port, U_Phase_W_Pin);

    HAL_GPIO_DeInit(I_Phase_W_GPIO_Port, I_Phase_W_Pin);
  ...
  /* USER CODE END ADC3_MspDeInit 0 */
    ...
    PC3_C     ------> ADC3_INP1
    */
    HAL_GPIO_DeInit(U_Supply_GPIO_Port, U_Supply_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END LPUART1_MspDeInit 0 */
    ...
    PB6     ------> LPUART1_TX
    */
    HAL_GPIO_DeInit(GPIOB, External_uart_RX_Pin|External_uart_TX_Pin);
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PD1     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOD, DEBUG_RX_Pin|DEBUG_TX_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB13     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOB, Driver_Sen_MOSI_Pin|Driver_Sen_MISO_Pin|Driver_Sen_SCK_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOC, EXT_SEN_MISO_Pin|EXT_SEN_SCK_Pin|EXT_SEN_MOSI_Pin);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE13     ------> TIM1_CH3
    */
    HAL_GPIO_DeInit(GPIOE, PWM_V_L_Pin|PWM_V_H_Pin|Driver_fault_Pin|PWM_U_L_Pin
                          |PWM_W_L_Pin|PWM_U_H_Pin|PWM_W_H_Pin);
